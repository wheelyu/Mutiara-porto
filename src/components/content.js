        ...
        >
          <div className="md:w-1/2 text-center md:text-left ">
            ...
            <button class="overflow-hidden relative w-36 p-2 h-12 bg-blue-500 text-white border-none rounded-md text-xl font-bold cursor-pointer  z-0 group">
              Resume
              <span class="absolute w-40 h-32 -top-8 -left-2 bg-blue-200 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-500 duration-1000 origin-left"></span>
              <span class="absolute w-40 h-32 -top-8 -left-2 bg-blue-400 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-700 duration-700 origin-left"></span>
              <span class="absolute w-40 h-32 -top-8 -left-2 bg-blue-700 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-1000 duration-500 origin-left"></span>
